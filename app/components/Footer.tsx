        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link href="/auth/signup?role=employer" className="text-gray-600 hover:text-[#E91E63]">
                  Post a Job
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link href="/auth/signup?role=employee" className="text-gray-600 hover:text-[#E91E63]">
                  Create Account
                </Link>
              </li>
              <li>
