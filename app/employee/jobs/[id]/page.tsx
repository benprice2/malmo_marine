...
export default function JobDetails() {
  ...
  if (error || !job) {
    return (
      <div className="text-center py-8">
        ...
        <Link href="/employee/jobs" className="text-[#E91E63] hover:underline">
          Back to Jobs
        </Link>
      </div>
    );
  ...
  return (
    <div>
      <Link href="/employee/jobs" className="inline-flex items-center text-[#E91E63] hover:underline mb-6">
          ...
          <div className="bg-gray-50 p-6 rounded-lg">
            ...
            {!session ? (
              <div>
                ...
                <Link
                  href={`/auth/signin?callbackUrl=/employee/jobs/${jobId}`}
